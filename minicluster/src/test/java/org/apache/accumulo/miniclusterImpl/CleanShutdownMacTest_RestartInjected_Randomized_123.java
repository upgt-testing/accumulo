...
public class CleanShutdownMacTest_RestartInjected_Randomized_123 extends WithTestNames {
    ...
    public void testExecutorServiceShutdown() throws Exception {
        ...
        cluster.stop();
        RestartFramework.at("after_cluster_create").on(cluster).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
