...
public class MultiTableInputFormatIT_RestartInjected_Randomized_123 extends AccumuloClusterHarness {
    ...
    private static class MRTester extends Configured implements Tool {
        ...
        public int run(String[] args) throws Exception {
            ...
            AccumuloInputFormat.configure().clientProperties(getClientProps()).table(table1).table(table2).store(job);
