...
public class NewTableConfigurationIT_RestartInjected_Randomized_123 extends SharedMiniClusterBase {
    ...
    public void testPreconfigureIteratorWithDefaultIterator1() throws AccumuloException, TableNotFoundException, AccumuloSecurityException, TableExistsException {
        try (AccumuloClient client = Accumulo.newClient().from(getClientProps()).build()) {
            ...
            verifyIterators(client, tableName, new String[] { "table.iterator.scan.anIterator=10,it.class" }, true);
    ...
    public void testSettingInitialIteratorWithAdditionalIteratorOptions() throws AccumuloException, TableNotFoundException, AccumuloSecurityException, TableExistsException {
        try (AccumuloClient client = Accumulo.newClient().from(getClientProps()).build()) {
            ...
            ntc.attachIterator(setting);
            client.tableOperations().create(tableName, ntc);
            verifyIterators(client, tableName, new String[] { "table.iterator.scan.someName=10,foo.bar", "table.iterator.scan.someName.opt.key=value" }, true);
            client.tableOperations().removeIterator(tableName, "someName", EnumSet.of(IteratorScope.scan));
            verifyIterators(client, tableName, new String[] {}, true);
        }
    }
    ...
    public void testMultipleIteratorValid() throws AccumuloException, TableNotFoundException, AccumuloSecurityException, TableExistsException {
        try (AccumuloClient client = Accumulo.newClient().from(getClientProps()).build()) {
            ...
            ntc.attachIterator(setting, EnumSet.of(IteratorScope.scan));
            client.tableOperations().create(tableName, ntc);
            verifyIterators(client, tableName, new String[] { "table.iterator.scan.firstIterator=10,first.class", "table.iterator.scan.secondIterator=11,second.class" }, true);
            client.tableOperations().removeIterator(tableName, "firstIterator", EnumSet.of(IteratorScope.scan));
            verifyIterators(client, tableName, new String[] { "table.iterator.scan.secondIterator=11,second.class" }, true);
            client.tableOperations().removeIterator(tableName, "secondIterator", EnumSet.of(IteratorScope.scan));
            verifyIterators(client, tableName, new String[] {}, true);
        }
    }
