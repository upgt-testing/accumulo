...
@Tag(SUNNY_DAY)
public class ShellIT_RestartInjected_Randomized_456 extends SharedMiniClusterBase {
    ...
    void execExpectList(String cmd, boolean expecteGoodExit, List<String> expectedStrings) throws IOException {
        ...
        for (String expectedString : expectedStrings) {
            assertTrue(output.get().contains(expectedString), expectedString + " was not present in " + output.get());
        }
    }
    ...
    void assertGoodExit(String s, boolean stringPresent) {
        ...
        if (!s.isEmpty()) {
            assertEquals(stringPresent, output.get().contains(s), s + " present in " + output.get() + " was not " + stringPresent);
        }
    }
    ...
    public void addGetSplitsTest() throws IOException {
        ...
        RestartFramework.at("after_splits_add").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void insertDeleteScanTest() throws IOException {
        RestartFramework.at("after_data_insert").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Shell.log.debug("Starting insertDeleteScan test ------------------------");
        RestartFramework.at("before_test_table_delete").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        exec("createtable test", true);
        RestartFramework.at("after_test2_data_insert").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_test_table_create").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("before_test2_table_delete").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        exec("scan -t test2", true, "r1 f1:q1 []\tv1", false);
        exec("scan -t test2", true, "r2 f2:q2 []\tv2", true);
        exec("delete r2 f2 q2 --table test2", true);
        RestartFramework.at("after_test2_table_create").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        exec("scan -t test2", true, "r1 f1:q1 []\tv1", false);
    ...
    public void insertIntoSpecifiedTableTest() throws IOException {
        ...
        RestartFramework.at("after_tab2_data_insert").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_tab3_create").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_tab2_create").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_tab3_data_insert").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_tab1_data_insert").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        // should be able to insert w/o changing tables
        ...
        RestartFramework.at("after_tab1_create").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void deleteManyTest() throws IOException {
        ...
        RestartFramework.at("after_test_create").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void duContextTest() throws Exception {
        ...
        RestartFramework.at("after_t_create").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void duPatternTest() throws IOException {
        ...
        exec("createtable t", true);
        RestartFramework.at("after_tt_create").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_t_create").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void scanFewTest() throws IOException {
        ...
        String name = getUniqueNames(1)[0];
        exec("createtable " + name, true);
        RestartFramework.at("after_data_insert_and_auths").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void scanDateStringFormatterTest() throws IOException {
        ...
        exec("scan -fm org.apache.accumulo.core.util.format.DateStringFormatter -st -f 5", true, expected);
    ...
    void configPropertyTest() throws IOException {
        ...
        try {
            ...
            exec(filterProperty + "table.iterator.scan.vers.opt.maxVersions", true, "table      | table.iterator.scan.vers.opt.maxVersions .. | 1\n");
            // set to new value and verify results
            exec(setProperty + "table.iterator.scan.vers.opt.maxVersions=2", true);
            exec(filterProperty + "table.iterator.scan.vers.opt.maxVersions", true, "table      | table.iterator.scan.vers.opt.maxVersions .. | 2\n");
            ...
            exec(filterProperty + "table.iterator.scan.vers.opt.maxVersions", true, "table      | table.iterator.scan.vers.opt.maxVersions .. | \n");
            ...
            exec(filterProperty + "table.file.compress.type", true, "default    | table.file.compress.type .................. | gz\n");
    ...
    void configTest() throws IOException {
        ...
        for (Property property : Property.values()) {
            ...
            if (!Property.isValidZooPropertyKey(property.getKey())) {
                Shell.log.debug("Property {} with type {} cannot be modified by shell", property.getKey(), propertyType);
                continue;
            }
            switch(propertyType) {
                case PATH:
            ...
            exec(setCommand + property.getKey() + "=" + invalidValue, false, "ThriftPropertyException(property:" + property.getKey() + ", value:" + invalidValue + ", description:");
    ...
    public void execFileTest() throws IOException {
        ...
        shell.config("--config-file", config.toString(), "-u", "root", "-p", getRootPassword(), "-zi", getCluster().getInstanceName(), "-zh", getCluster().getZooKeepers(), "-f", "src/main/resources/org/apache/accumulo/test/shellit.shellit");
    ...
    public void testMaxSplitsOption() throws Exception {
        ...
        RestartFramework.at("after_maxtab_create").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
