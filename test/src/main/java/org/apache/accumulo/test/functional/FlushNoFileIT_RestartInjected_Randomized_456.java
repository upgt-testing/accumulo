 ...
 */
public class FlushNoFileIT_RestartInjected_Randomized_456 extends AccumuloClusterHarness {
    ...
    public void test() throws Exception {
        try (AccumuloClient c = Accumulo.newClient().from(getClientProps()).build()) {
            ...
            RestartFramework.at("after_second_write").on(getCluster()).restart("tablet_server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            c.tableOperations().flush(tableName, null, null, true);
