...
// Accumulo3047
public class BadDeleteMarkersCreatedIT_RestartInjected_Randomized_456 extends AccumuloClusterHarness {
    ...
    public void test() throws Exception {
        ...
        try (AccumuloClient c = Accumulo.newClient().from(getClientProps()).build()) {
            ...
            RestartFramework.at("after_delete_rows").on(getCluster()).restart("tablet_server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            try (Scanner scanner = c.createScanner(MetadataTable.NAME, Authorizations.EMPTY)) {
                ...
                for (Entry<Key, Value> entry : scanner) {
                    ...
                    fail("Delete entry should have been deleted by the garbage collector: " + entry.getKey().getRow());
                }
            }
        }
    }
