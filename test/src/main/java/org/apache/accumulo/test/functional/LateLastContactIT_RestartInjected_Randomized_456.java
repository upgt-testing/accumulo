 ...
 */
public class LateLastContactIT_RestartInjected_Randomized_456 extends ConfigurableMacBase {
    ...
    public void test() throws Exception {
        ...
        RestartFramework.at("after_start_zombie_tserver").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
