...
// ACCUMULO-3967
public class BulkImportSequentialRowsIT_RestartInjected_Randomized_123 extends AccumuloClusterHarness {
    ...
    public void testBulkImportFailure() throws Exception {
        ...
        try (AccumuloClient client = Accumulo.newClient().from(getClientProps()).build()) {
            ...
            assertEquals(0, fsShell.run(new String[] { "-chmod", "-R", "777", rootPath.toString() }), "Failed to chmod " + rootPath);
            // Add some splits
