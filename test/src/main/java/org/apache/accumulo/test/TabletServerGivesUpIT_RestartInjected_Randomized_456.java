...
// ACCUMULO-2480
public class TabletServerGivesUpIT_RestartInjected_Randomized_456 extends ConfigurableMacBase {
    ...
    public void test() throws Exception {
        try (AccumuloClient client = Accumulo.newClient().from(getClientProperties()).build()) {
            ...
            RestartFramework.at("after_tablet_servers_up").on(getCluster()).restart("tablet_server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
