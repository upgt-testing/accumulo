...
public class BinaryIT_RestartInjected extends AccumuloClusterHarness {
  ...
  public static void runTest(AccumuloClient c, String tableName, AccumuloCluster cluster)
      throws Exception {
