...
public class ThriftServerBindsBeforeZooKeeperLockIT_RestartInjected extends AccumuloClusterHarness {
  private static final Logger LOG =
      LoggerFactory.getLogger(ThriftServerBindsBeforeZooKeeperLockIT_RestartInjected.class);
