...
public class ThriftMaxFrameSizeIT_RestartInjected_Randomized_123 {
    ...
    protected abstract class TestMaxFrameSize extends ConfigurableMacBase {
        ...
        private void testWithSpecificSize(final int testSize) throws Exception {
            ...
            try (var accumuloClient = Accumulo.newClient().from(cluster.getClientProperties()).build()) {
                ...
                RestartFramework.at("after_verify").on(getCluster()).restart("tablet_server").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            }
        }
        ...
        public void testFrameSizeGreaterThanConfiguredMax() throws Exception {
            ...
            assertThrows(AssertionError.class, () -> assertTimeoutPreemptively(Duration.ofSeconds(15), () -> testWithSpecificSize(testSize)));
        }
    }
}
