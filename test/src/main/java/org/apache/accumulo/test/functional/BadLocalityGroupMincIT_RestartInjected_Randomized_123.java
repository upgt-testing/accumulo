...
public class BadLocalityGroupMincIT_RestartInjected_Randomized_123 extends AccumuloClusterHarness {
    ...
    public void test() throws Exception {
        try (AccumuloClient c = Accumulo.newClient().from(getClientProps()).build()) {
            ...
            RestartFramework.at("after_locality_group_config").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
