...
public class DetectDeadTabletServersIT_RestartInjected_Randomized_456 extends ConfigurableMacBase {
    ...
    public void test() throws Exception {
        try (AccumuloClient c = Accumulo.newClient().from(getClientProperties()).build()) {
            ...
            RestartFramework.at("after_initial_verification").on(getCluster()).restart("manager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
