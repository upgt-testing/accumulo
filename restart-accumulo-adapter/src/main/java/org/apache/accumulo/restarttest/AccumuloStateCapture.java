...
/**
 * State capture for Accumulo cluster.
 * Captures metadata about tables, tablets, and servers.
 */
public class AccumuloStateCapture extends AbstractStateCapture<MiniAccumuloCluster> {

  private static final Logger log = LoggerFactory.getLogger(AccumuloStateCapture.class);

  @Override
  public ClusterState captureState(MiniAccumuloCluster cluster) throws Exception {
  ...
  @Override
  protected void verifyCustomInvariants(MiniAccumuloCluster cluster,
                                       ClusterState before,
